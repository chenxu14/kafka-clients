...
public class KafkaProducer<K, V> implements Producer<K, V> {
    ...
    private Future<RecordMetadata> doSend(ProducerRecord<K, V> record, Callback callback) {
        ...
        try {
            ...
            // need rewind since we may read some bytes from ByteBuffer
            if (serializedKey != null && serializedKey != Bytes.EMPTY_BUFFER) {
              serializedKey.rewind();
            }
            if (serializedValue != null && serializedValue != Bytes.EMPTY_BUFFER) {
